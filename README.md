...
<p>ID clashed with competitions section ID on competitions page which caused the text to be centered in the drop down menu on the contact form page. Renamed the id to competitons-query to fix.
</p>
